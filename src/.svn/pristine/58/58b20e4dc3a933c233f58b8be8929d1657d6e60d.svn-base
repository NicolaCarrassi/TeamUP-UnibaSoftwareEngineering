...
define('ATTR_NOT_VALID', "Il formato di ':attribute' non è valido.");
...
return [
    ...
    */
    ...
    ARR                => "':attribute' deve essere un array.",
    'before'               => "'Per essere registrati bisogna avere una età minima di 13 anni'",
    ...
    'between'              => [
       ...
       STRING  => "':attribute' deve essere compreso tra :min and :max caratteri.",
        ARR   => "':attribute' deve essere compreso tra :min and :max elementi.",
    ],
    ...
    'gt'                   => [
       ...
       STRING  => "':attribute' deve contenere più di :value caratteri.",
        ARR   => "':attribute' deve contenere più di :value elementi.",
    ],
    'gte'                  => [
       ...
       STRING  => "':attribute' deve contenere almeno :value caratteri.",
        ARR   => "':attribute' deve contenere almeno :value elementi.",
    ],
    'images'                => "':attribute' deve essere un'immagine.",
    ...
    'lt'                   => [
       ...
       STRING  => "':attribute' deve contenere meno di :value caratteri.",
        ARR   => "':attribute' deve contenere meno di :value elementi.",
    ],
    'lte'                  => [
       ...
       STRING  => "':attribute' deve contenere non più di :value caratteri.",
        ARR   => "':attribute' deve contenere non più di :value elementi.",
    ],
    'max'                  => [
       ...
       STRING  => "':attribute' non può essere più lungo di :max caratteri.",
        ARR   => "':attribute' non può contenere più di :max elementi.",
    ],
    ...
    'size'                 => [
       ...
       STRING  => "':attribute' deve essere di :size caratteri.",
        ARR   => "':attribute' deve contenere :size elementi.",
    ],
