            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        <div class="d-flex features-icons-icon"><em class="icon-people m-auto text-primary" data-bs-hover-animate="pulse"></em></div>
                ...
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        <div class="d-flex features-icons-icon"><em class="icon-control-forward m-auto text-primary" data-bs-hover-animate="pulse"></em></div>
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    ...
                    <p class="lead mb-0">Grazie a TeamUp è possibile realizzare quel progetto che hai sempre sognato ma non hai mai realizzato perchè non hai mai trovato le persone con cui realizzarla</p>
                </div>
            </div>
            <div class="row no-gutters">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    ...
                    <p class="lead mb-0">TeamUp è completamente gratuito, non avrai limitazioni sulla creazione di progetti e sulla partecipazione a quelli degli altri</p>
                </div>
            </div>
        </div>
    </section>
