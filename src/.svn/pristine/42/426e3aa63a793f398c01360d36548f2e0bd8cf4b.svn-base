...
<div class="messenger">
        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($route == 'user') class="active-tab" @endif data-view="users">
                    <span class="far fa-user"></span> Utenti</a>
            </div>
        </div>
        {{-- tabs and lists --}}
        <div class="m-body">
           ...
           <div class="messenger-tab app-scroll" data-view="search">
                {{-- items --}}
                <p class="messenger-title">Cerca</p>
                <div class="search-records">
                    <p class="message-hint"><span>Scrivi per cercare...</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="internet-connection">
            ...
            <span class="ic-connecting">Connessione...</span>
            <span class="ic-noInternet">Nessun accesso ad internet</span>
        </div>
        {{-- Messaging area --}}
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span>Scegli una chat per iniziare a messaggiare</span></p>
            </div>
            {{-- Typing indicator --}}
