/**
 * La funzione permette di inserire elementi enlla tabella delle competenze
 */
...
/**
 * Il metodo effettua il controllo delle competenze inserite dall'utente, non verificate dagli amministratori
 *
 */
