...
Route::post('/idea/tasks/paginate', 'Idea\ProjectController@tasksPagination')->name('taskspagination');
Route::post('/idea/feeds/paginate', 'Idea\ProjectController@feedsPagination')->name('feedspagination');
...
Route::get('/profile/storico/storicoprog','ProfilesController@showProjectArchive')->name('storicoprog');
Route::get('/profile/progattivi/progettiattivi','ProfilesController@showActiveProjects')->name('progattivi');
Route::get('/profile/progattivi/progettiattivi/annulla/{id}', 'Idea\ProjectController@annullaRichiesta')->name('annullaRichiesta');
Route::get('/profile/partecip/partecipazioni','ProfilesController@showPartecipationList')->name('partecip');
Route::get('/profile/{user}', 'ProfilesController@index')->name('profile');

//Route relative alla gestione della ricerca delle idee e alla visualizzazione di tutte le idee
Route::get('/search', 'idea\ControllerShowIdeas@showSearchView')->name('searchPane');
