            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="ml-4 nav-item active border-left border-dark">
                        <a id="newidea" class="ml-4 nav-link" href="{{route('createProjectualIdea')}}">Nuova Idea <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item active ">
                        <a id="searchidea" class="nav-link" href="{{route('searchPane')}}" tabindex="-1" aria-disabled="true">Cerca idea</a>
                    </li>
                    <li class="nav-item active">
                        <a id="rightchat" class="nav-link" href="/chat/{{Auth::id()}}">Chat <span class="sr-only"></span></a>
                    </li>
                    @endauth
                        @guest()
                            <li class="nav-item active ">
                                <a id="allidea" class="nav-link" href="{{route('allIdeas')}}" tabindex="-1" aria-disabled="true">Visualizza le idee</a>
                            </li>
                        @endguest
                </ul>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        ...
                        <li id="userimg" class="nav-item dropdown d-flex">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <!-- Visualizza Profilo -->
                                <a id="seeprofile" class="dropdown-item" href="{{ url('/profile/' . Auth::user()->id) }}">
                                    {{ __('Visualizza profilo') }}
                                </a>

                                <!-- Chat  -->
                                <a id="chat" class="dropdown-item" href="{{ url('/chat/' . Auth::user()->id) }}">
                                    {{ __('Chat') }}
                                </a>

                                <!-- Divider -->
                                <div id="navbardivider" class="dropdown-divider"></div>
